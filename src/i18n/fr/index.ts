...
export default {
  ...
  HPseluser_2: 'Liste des utilisateurs ayant accordé leur confiance dans ce terminal',
  ...
  HPcsret_19: 'BUG - Echec de la mise à jour des codes d\'accès: l\'utilisateur n\'est pas enregistré.',
