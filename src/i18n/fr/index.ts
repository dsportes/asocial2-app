...
export default {
  ...
  HPrecup: 'Je veux changer ou récupérer mes codes d\'accès (ou oubli de mes codes principaux).',
  ...
  HPcrecup: 'Codes d\'authentification ou de récupération actuels',
  HPcode_1: 'Déclaration des codes d\'authentification',
  HPcode_2: 'Vérification des codes d\'authentification',
  HPcode_3: 'Déclaration des codes de récupération',
  HPcode_4: 'Vérification des codes de récupération',
  HPerr_1: 'Initiales / trigramme absent ou incorrect',
  HPerr_2: 'Codes d\'authentification absent ou invalide',
  HPerr_3: 'Codes d\'authentification: vérification échouée',
  HPerr_4: 'Codes de récupération absent ou invalide',
  HPerr_5: 'Codes de récupération: vérification échouée',
  HPpseudo: 'Pseudo, nom ... : {0}',
  HPps: 'Phrase secrète : {0}',
  HPca: 'Codes d\'authentification',
  ...
  HPcsret_02: 'Echec de l\'enregistrement: changer de "pseudo d\'authentification".',
  HPcsret_03: 'Echec de l\'enregistrement: changer de "pseudo de récupération".',
  ...
  HPcsret_12: 'Echec de la mise à jour des codes d\'accès: changer de "pseudo d\'authentification".',
  HPcsret_13: 'Echec de la mise à jour des codes d\'accès: changer de "pseudo de récupération".',
