...
export default {
  ...
  HPph_1: 'Etape 1 : déclaration des codes d\'authentification',
  HPph_2: 'Etape 2 : vérification des codes d\'authentification',
  HPph_3: 'Etape 3 : déclaration des codes de récupération',
  HPph_4: 'Etape 6 : vérification des codes de récupération',
  HPcauth: 'Codes d\'authentification:',
  HPcrecup: 'Codes de récupération:',
  HPstep: 'Etapes: ',
